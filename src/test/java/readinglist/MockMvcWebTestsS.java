...
public class MockMvcWebTestsS {
  ...
  @Test
  //@WithUserDetails("user1")//("craig")
  @WithMockUser(username="user1", password="user1Pass", roles="READER")//(username="craig", password="password", roles="READER")
